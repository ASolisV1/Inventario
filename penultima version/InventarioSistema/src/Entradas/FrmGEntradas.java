...
/** @author WASM    */
public class FrmGEntradas extends javax.swing.JFrame {
    
    private CtrlEntradas controlador;
    
    public FrmGEntradas() {
        initComponents();
        controlador=new CtrlEntradas(this);
        preTabla();
    }    
    
    public void preTabla(){
        QueryEntradas  prueba= new QueryEntradas();
        ArrayList <ClsEntradas> marcas = prueba.marcasArr();
        initTabla(marcas);
    }
    
    public void initTabla(ArrayList <ClsEntradas> m){        
        ...
        for(int  i=0; i<m.size();i++){
            String[] fila={Integer.toString(i+1),Integer.toString(m.get(i).getEntcod()),m.get(i).getEntdoc(),
            m.get(i).getEntprodnom(),Integer.toString(m.get(i).getEntcant()), Integer.toString(m.get(i).getEntdia()),
                    Integer.toString(m.get(i).getEntmes()),Integer.toString(m.get(i).getEntanio())};
            modelo.addRow(fila);   }
    }
    ...
    private void initComponents() {
        ...
        btnEliminar.setText("Eliminar Entrada");
        ...
        btnEditar.setText("Editar Entrada");
  ...
  //      frm.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmGEntradas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmGEntradas().setVisible(true);
            }
        });
    }
