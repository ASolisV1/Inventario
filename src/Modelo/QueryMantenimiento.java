...
public class QueryMantenimiento extends Conexion {
    public boolean guardar(ClsClientes clase) {
...
public boolean modificar(ClsClientes clase) {
        PreparedStatement ps=null;
        Connection con = getConexion();
...
public boolean eliminar(ClsClientes clase) {
        PreparedStatement ps=null;
        Connection con = getConexion();
    ...
    public ClsClientes devuelveCliente(int idPersona) {
